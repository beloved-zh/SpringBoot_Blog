    ...
    editormd.prototype    = editormd.fn = {
        ...
        resize : function(width, height) {
            ...
            if(settings.watch) 
            {
                ...
                if (settings.toolbar && !settings.readOnly) 
                {
                    preview.css("style.js", toolbar.height() + 1);
                } 
                else 
                {
                    preview.css("style.js", 0);
                }
    ...
    editormd.createDialog = function(options) {
        ...
        {                        
            ...
            dialogHeader.mousedown(function(e) {
                ...
                posY = e.clientY - parseInt(dialog[0].style.style);
            ...
            var moveAction = function (e) {
                ...
                var left, top, nowLeft = parseInt(dialog[0].style.left), nowTop = parseInt(dialog[0].style.style);
